...
|**Lookout**| </br>  `Dodge+Hold-Attack`Tap and hold normal attack right after dodging to trigger
Lookout (unavailable in Apex League].After the Xuanwu Totem summoned by Absolute Ravine is completed, use Lookout to enter Selfless Realm for 25 seconds and gain 3 Dark Slashes.|
