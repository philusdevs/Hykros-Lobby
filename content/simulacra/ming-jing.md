...
|**Lookout**| </br>  `Dodge+Hold-Attack`Press and hold the regular attack immediately after evading to trigger "Lookout" (unavailable in the Apex League).When the construction of the Yuanwu Totem summoned by Absolute Ravine is completed, use "Lookout" to enter the "Altruistic Kingdom" for 25 seconds and gain 3 Stack.|
|**Dark Cut**| </br>  After the first successful regular attack or attack with Onyx Tortoise's evasion, "Dark Cut" is triggered. If the target is a common or aggressive enemy, and its current HP does not exceed the Wanderer's max. ATK value multiplied by 20,000, the target will be instantly destroyed. Otherwise, it will receive damage equal to `1500%` of ATK. The "Altruistic Kingdom" ends when the duration expires, "Dark Cuts" are used up, or you switch weapons. The "Altruistic Kingdom" can be activated no more than 1 time.|
