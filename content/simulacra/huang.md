...
description: Huang, featured as an obtainable SSR Simulacrum within the simulacrum system, associated with the weapon Meng Zhang.
---
...
**Call Lightning:** When Meng Zhang hits a target, Call Lightning chase damage can be triggered once every 1.5s.
...
1★ When using the Held Normal of Meng Zhang, summon 2 Little Azure Dragons once. Each Little Azure Dragon restores the HP of summoned objects by 20%. The Held Normal of Meng Zhang and the damage of Little Azure Dragons are also increased by 50%. Obtain 3 stacks of Azure Dragon Power when using Meng Zhang's Skill. Obtain 1 stack of Azure Dragon Power when using other Volt weapon's Skills.			
...
5★ Resist fatal damage and gain damage immunity for a short time. 60s cd. This effect can activate in the background. When Fortitude Resonance is active, Meng Zhang's Discharge will have a minor suction effort towards non-boss enemies, bypassing superarmor. When Fortitude Resonance is active and you are in team play, every time Meng Zhang hits with the Held Normal, every 6s generate a Lightning Timestamp.Lightning Timestamps will chain together to form a Power Grid which lasts up to 20s that blocks the movement and projectiles of enemies.	

6★ After using Meng Zhang's Skill, increase 15% Volt Damage and 25% Final Damage for 30s.					
