...
> Increase final damage by 18%. When Black Bamboo is the current active weapon, all elemental damage is increased by 14% for each equipped weapon of different element.
...
6★ Hyperspace damage's base multiplier is increased to 0.12% of total wanderer damage in
Hyperspace [not including Shadow damage] plus 4,000% of ATK.
